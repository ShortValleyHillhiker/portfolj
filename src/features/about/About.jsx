...
export const About = (props) => {
  ...
  return (
    <>
      <div class="About-me">
        <h2>Victor Vennerström</h2>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus leo
          orci, porttitor venenatis rhoncus at, auctor eu diam. Cras consectetur
          nisi elit, at aliquet mauris dictum eget. Vestibulum quis ligula
          nulla. Aliquam erat volutpat. Etiam mollis lacus sem, ut suscipit
          tortor commodo et. Sed hendrerit eleifend dolor..
        </p>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus leo
          orci, porttitor venenatis rhoncus at, auctor eu diam. Cras consectetur
          nisi elit, at aliquet mauris dictum eget.
        </p>
        <button
