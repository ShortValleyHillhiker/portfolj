...
import { MySwiper } from "./features/swiper/Swiper";
import { CaseSwiper } from "./features/swiper/CaseSwiper";
import { Navigation } from "./features/navigation/Navigation";
import { SwiperSlide } from "swiper/react";
import { setActiveSlides } from "./features/modal/modalSlice";
...
function App() {
  ...
  switch (slideTitle) {
    ...
    case "Case1":
      content.push(
        <>
          <Case>
            <SwiperSlide className="custom-full" id="case-bg-one"></SwiperSlide>
            <SwiperSlide className="custom-standard">
              <h1 class="case-title">The Case Title</h1>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras
                nec dictum nunc. Maecenas facilisis aliquet lacus, vel hendrerit
                urna iaculis a.
              </p>
            </SwiperSlide>
            <SwiperSlide className="custom-standard">
            ...
            <SwiperSlide className="custom-full" id="case-bg-two">
              <table>
                <tr>
                  <th>AD</th>
                  <td>Victor Vennerström</td>
                </tr>
                <tr>
                  <th>CW</th>
                  <td>Jane Doe</td>
      ...
      content.push(
        <>
          <Case>
            ...
            <SwiperSlide className="custom-full" id="case-bg-four">
              <table>
                <tr>
                  <th>AD</th>
                  <td>Victor Vennerström</td>
  ...
  //https://www.youtube.com/watch?v=sxFyVfb5RME&ab_channel=LetsCode
  //Kevin help plz
